...
| 버전 | 주요 변경 | 비고 |
|------|-----------|------|
| **v1.1.0** | `/ship-all` GAN 루프 기본 활성화 + Review 컬럼 생성 버그 수정 | 현재 최신 |
...
설치된 버전(`v1.1.0`)과 현재 패키지 버전이 다르면 **업데이트 경고**가 표시됩니다. 서브에이전트 3종이 모두 `✔`가 아니면 GAN 루프가 동작하지 않으니 재설치하세요.
